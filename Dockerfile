...
#install verilator
ENV VERILATOR_VERSION=v5.044
RUN apt-get -y update && apt-get -y install wget sudo help2man clang git perl python3 make autoconf g++ flex bison cmake ninja-build  zlib1g zlib1g-dev python3-venv lcov \
